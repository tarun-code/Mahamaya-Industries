...
$meta_title="Mahamaya Industries";
$meta_desc="Mahamaya Industries";
$meta_keyword="Mahamaya Industries";
$meta_url=SITE_PATH;
$meta_image="";
                            ...
                            <div class="col-md-7 col-lg-6 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        ...
                                        <li><a href="services.php"> Vision </a></li>
